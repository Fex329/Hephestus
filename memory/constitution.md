...
| 2026-03-23 | All 5 repos migrated to GitHub as `origin`; local bare repos in `repos\` are archived and no longer used | Completed as part of reorg-1. Remotes: Ame-no-Mahitotsu/Hephestus, Ame-no-Mahitotsu/Tools, Ame-no-Mahitotsu/SitoPresepe, Ame-no-Mahitotsu/Docs, Ame-no-Mahitotsu/Backoffice. Prior constitution entry (2026-03-13) referring to local bare repo as origin is superseded. `ai-standards.md` repository structure updated accordingly. | Owner + Alessandro |
...
| 2026-03-29 | Frontend stack corrected: Next.js 16.x (was 14.x in ai-standards.md) | ISS-191 G5 review identified the discrepancy — `package.json` pins `next: ^16.2.1`. ai-standards.md Technology Stack table updated. Prior 14.x entry was never correct for this codebase. | Owner + Alessandro |
| 2026-03-30 | Hosting changed: DigitalOcean Frankfurt → Hetzner Cloud CPX21, Nuremberg/Falkenstein | 5-provider EU VPS comparison (docs/site/vps_provider_comparison.md) by Patrick + Salvatore. Hetzner wins on price-performance (€9.60/mo all-in vs ~€29 DO), German GmbH entity (cleanest GDPR posture for IT/EN/DE site), ISO 27001, 3 AMD vCPU / 4 GB / 80 GB NVMe, 20 TB traffic included, €1/TB overage. No server provisioned yet — deferred until a working website is ready for deployment. Prior 2026-03-12 DigitalOcean entry superseded. | Owner + Patrick + Salvatore |
